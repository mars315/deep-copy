...
func Test_run(t *testing.T) {
	tests := []struct {
		...
		{name: "player", types: typesVal{"Player"}, path: "./testdata", want: []byte(PlayerFile)},
...
const (
	PlayerFile = `// generated by deep-copy; DO NOT EDIT.

package testdata

// DeepCopy generates a deep copy of Player
func (o Player) DeepCopy() Player {
	var cp = o
	if o.Basic != nil {
		cp.Basic = new(Basic)
		*cp.Basic = *o.Basic
